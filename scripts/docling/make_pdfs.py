...
DOCUMENTS = [
    ...
    (
        ...
        "2026 Q2 — IT Equipment Suppliers (incorporating the 2026-Q3 addendum)",
        [
            ...
            # A vendor's standing changes without the rest of the document changing,
            # which is why suspension arrives as a dated addendum rather than an edit
            # to AVL-3. The evaluator treats suspension as strictly stronger than
            # approval, so this sentence overrides the approval three lines above it.
            (
                "addendum 2026-Q3",
                "Vendor Suspension — Lenovo",
                "Lenovo is temporarily suspended pending completion of a supply-chain "
                "security audit; no new orders may be placed until the suspension is lifted.",
            ),
        ],
    ),
    (
